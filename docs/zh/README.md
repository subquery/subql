...
<div class="top2Sections">
  ...
  <section class="startSection main">
    <div>
      ...
      <p>Understand SubQuery by getting hands on with a traditional Hello World example. Understand SubQuery by getting hands on with a traditional Hello World example. Using a template project within a Docker environment, you can quickly get a node up and running and start querying a blockchain in just a few minutes with a few simple commands.
      </p>
    ...
    <ul class="list">
      ...
      <li>
        <a href="https://doc.subquery.network/create/introduction.html">
          <div>
            ...
            <p>Written by developers for developers. <div>
            <img src="/assets/img/docsIcon.svg" />
            <span>Technical Reference Docs</span>
      ...
      <li>
        <a href="https://static.subquery.network/whitepaper.pdf" target="_blank">
          ...
          </div> Read more about how indexers and consumers are rewarded.</p>
          </div>
        </a>
      </li>
    </ul>
  ...
  <div>
    ...
    <ul class="faqList">
      ...
      <li>
        ...
        <div class="content">
          <p>Hosting your project in SubQuery Projects is absolutely free - it's is our way of giving back to the community. To learn how to host your project with us, please check out the <a href="https://doc.subquery.network/quickstart/helloworld-hosted.html">Hello World (SubQuery Hosted)</a> tutorial. To learn how to host your project with us, please check out the <a href="https://doc.subquery.network/quickstart/helloworld-hosted.html">Hello World (SubQuery Hosted)</a> tutorial.</p>
...
<section class="main">
  <div>
    <div class="lastIntroduce lastIntroduce_1">
        ...
        <p>Whether you're building a new parachain or an entirely new blockchain on Substrate - SubQuery can help you index and troubleshoot your chain's data. SubQuery is designed to easily integrate with a custom Substrate based chain. SubQuery is designed to easily integrate with a custom Substrate based chain.</p>
