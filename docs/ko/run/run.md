...
다른 솔루션은 `docker-compose.yml` 파일로 정의된 <strong>Docker Container</strong>를 실행하는 것입니다. For a new project that has been just initialised you won't need to change anything here.
