...
function getAllJsonObjects(_schema) {
  return Object.values(getSchema(_schema).getTypeMap())
    .filter((node) => {
      var _a, _b;
      return (_b = (_a = node.astNode) === null || _a === void 0 ? void 0 : _a.directives) === null || _b === void 0
        ? void 0
        : _b.find(({name: {value}}) => value === constant_1.DirectiveName.JsonField);
    })
    .map((node) => node)
...
function getAllEntitiesRelations(_schema) {
  ...
  const entities = Object.values(schema.getTypeMap())
    .filter((node) => {
      ...
      return (_b = (_a = node.astNode) === null || _a === void 0 ? void 0 : _a.directives) === null || _b === void 0
        ? void 0
        : _b.find(({name: {value}}) => value === constant_1.DirectiveName.Entity);
    })
    .filter(graphql_1.isObjectType);
    ...
    for (const field of Object.values(entity.getFields())) {
      ...
      // If is an enum
        ...
        newModel.fields.push({
          ...
          isEnum: true,
          isArray: (0, graphql_1.isListType)(
            (0, graphql_1.isNonNullType)(field.type) ? (0, graphql_1.getNullableType)(field.type) : field.type
          ),
