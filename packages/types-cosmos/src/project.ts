...
> {
  (original: CosmosRuntimeHandlerInputMap[T], ds: DS, api: StargateClient, assets: Record<string, string>): Promise<U>; //  | SubqlBuiltinDataSource
}
...
> {
  ...
  dsFilterProcessor(ds: DS, api: StargateClient): boolean;
  handlerProcessors: {
