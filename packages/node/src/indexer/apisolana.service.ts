...
@Injectable()
export class ApiSolanaService implements OnApplicationShutdown {
  ...
  async init(): Promise<ApiSolanaService> {
    ...
    this.networkMeta = {
      ...
      genesisHash: await this.api.getGenesisHash(),
    };
  ...
  //private patchApiRpc(api: Connection, apiAt: ApiAt): void {
