...
//
// @Injectable()
// export abstract class BaseRuntimeService implements OnApplicationShutdown {
...
//   }
//
//   async getLatestSpecVersionMap():Promise<SpecVersion[]>{
//     await this.syncDictionarySpecVersions()
//     return this.specVersionMap;
//   }
//
//   // If specVersion not found in local, should it sync from dictionary ?
//   async getSpecVersion(blockHeight: number, syncDictionary: boolean): Promise<number> {
...
//     const syncDictionary = height + SPEC_VERSION_BLOCK_GAP < this.latestFinalizedHeight;
//     if(specVersion === undefined){
//       specVersion = await this.getSpecVersion(height,syncDictionary);
//     }
