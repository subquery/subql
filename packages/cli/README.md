...
@subql/cli/0.20.2-0 linux-x64 node-v16.14.0
$ subql --help [COMMAND]
USAGE
  $ subql COMMAND
...
...
_See code: [lib/commands/build.js](https://github.com/packages/cli/blob/v0.20.2-0/lib/commands/build.js)_
...
_See code: [lib/commands/codegen.js](https://github.com/packages/cli/blob/v0.20.2-0/lib/commands/codegen.js)_
...
_See code: [lib/commands/init.js](https://github.com/packages/cli/blob/v0.20.2-0/lib/commands/init.js)_
...
_See code: [lib/commands/migrate.js](https://github.com/packages/cli/blob/v0.20.2-0/lib/commands/migrate.js)_
...
_See code: [lib/commands/publish.js](https://github.com/packages/cli/blob/v0.20.2-0/lib/commands/publish.js)_
...
OPTIONS
  ...
  --ipfs=ipfs              [default: https://ipfs.subquery.network/api/v0] IPFS gateway endpoint, used for validating
                           projects on IPFS

  --silent
```

_See code: [lib/commands/validate.js](https://github.com/packages/cli/blob/v0.20.2-0/lib/commands/validate.js)_
