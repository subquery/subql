...
running command...
$ subql (--version)
@subql/cli/5.1.1-0 linux-x64 node-v18.20.4
$ subql --help [COMMAND]
USAGE
  $ subql COMMAND
...
...
_See code: [lib/commands/build/index.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/build/index.js)_
...
_See code: [lib/commands/codegen/index.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/codegen/index.js)_
...
_See code: [lib/commands/codegen/generate.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/codegen/generate.js)_
...
_See code: [lib/commands/deployment/index.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/deployment/index.js)_
...
_See code: [lib/commands/deployment/delete.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/deployment/delete.js)_
...
_See code: [lib/commands/deployment/deploy.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/deployment/deploy.js)_
...
_See code: [lib/commands/deployment/promote.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/deployment/promote.js)_
...
_See code: [lib/commands/init.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/init.js)_
...
_See code: [lib/commands/migrate.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/migrate.js)_
...
_See code: [lib/commands/multi-chain/add.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/multi-chain/add.js)_
...
_See code: [lib/commands/multi-chain/deploy.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/multi-chain/deploy.js)_
...
_See code: [lib/commands/project/index.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/project/index.js)_
...
_See code: [lib/commands/project/create-project.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/project/create-project.js)_
...
_See code: [lib/commands/project/delete-project.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/project/delete-project.js)_
...
_See code: [lib/commands/publish.js](https://github.com/packages/cli/blob/v5.1.1-0/lib/commands/publish.js)_
