...
@subql/cli/0.25.1-0 linux-x64 node-v16.14.2
$ subql --help [COMMAND]
USAGE
  $ subql COMMAND
...
...
_See code: [lib/commands/build.js](https://github.com/packages/cli/blob/v0.25.1-0/lib/commands/build.js)_
...
_See code: [lib/commands/codegen.js](https://github.com/packages/cli/blob/v0.25.1-0/lib/commands/codegen.js)_
...
OPTIONS
  ...
  --specVersion=0.0.1|0.2.0|1.0.0  [default: 1.0.0] The spec version to be used by the project
```

_See code: [lib/commands/init.js](https://github.com/packages/cli/blob/v0.25.1-0/lib/commands/init.js)_
...
_See code: [lib/commands/migrate.js](https://github.com/packages/cli/blob/v0.25.1-0/lib/commands/migrate.js)_
...
_See code: [lib/commands/publish.js](https://github.com/packages/cli/blob/v0.25.1-0/lib/commands/publish.js)_
...
_See code: [lib/commands/validate.js](https://github.com/packages/cli/blob/v0.25.1-0/lib/commands/validate.js)_
