...
@subql/cli/0.6.2-0 linux-x64 node-v14.15.1
$ subql --help [COMMAND]
USAGE
  $ subql COMMAND
...
...
_See code: [lib/commands/build.js](https://github.com/packages/cli/blob/v0.6.2-0/lib/commands/build.js)_
...
_See code: [lib/commands/codegen.js](https://github.com/packages/cli/blob/v0.6.2-0/lib/commands/codegen.js)_
...
_See code: [lib/commands/init.js](https://github.com/packages/cli/blob/v0.6.2-0/lib/commands/init.js)_
<!-- commandsstop -->
