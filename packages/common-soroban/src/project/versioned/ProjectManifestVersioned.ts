...
import {ISorobanProjectManifest, SubqlSorobanDataSource} from '../types';
...
export function manifestIsV1_0_0(manifest: ISorobanProjectManifest): manifest is ProjectManifestV1_0_0Impl {
  return manifest.specVersion === '1.0.0';
}

export class SorobanProjectManifestVersioned implements ISorobanProjectManifest {
  ...
  get dataSources(): SubqlSorobanDataSource[] {
