...
import {ApiErrorType, ConnectionPoolStateManager, IApiConnectionSpecific} from '..';
...
describe('ConnectionPoolService', () => {
  ...
  beforeEach(() => {
    connectionPoolService = new ConnectionPoolService<typeof mockApiConnection>(new ConnectionPoolStateManager());
